...
/**
 * @dev UniswapV2Router01Intermediary is an interface between the 'real' UniswapV2Router01
 * and AvascaleSwap's Dapp. This allows differentiating the transactions that come from AvascaleSwap
 * or other services. This is useful for e.g. DappRadar.
 *
 * The fee functions are intended to be used when a user hasn't subscribed to AvascaleSwap, but
 * already used the free trial.
 */
contract UniswapV2Router01Intermediary is Ownable {
